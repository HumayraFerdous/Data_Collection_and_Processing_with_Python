...
# The variable nested_d contains a nested dictionary with the gold medal counts for the top four countries in the past three Olympics. Assign the value of Great Britain’s gold medal count from the London Olympics to the variable london_gold. Use indexing.
...
US_count = []
for item,val in nested_d.items():
    for idx,vl in val.items():
        if idx == 'USA':
            US_count.append(vl)
print(US_count)
